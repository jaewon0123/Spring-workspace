...
//@RequiredArgsConstructor 는 @Autowired 와 같지만 내부에서 하나씩 하나씩 해주는 것이 아니라 외부에서 전체적으로 설정
...
public class EmailService {
	...
	// 이메일을 보낼 이메일 주소값
	private static final String senderEmail = "doyou5389@gmail.com"; //이메일을 보낼 담당자 이메일 작성
	//application.properties 에서 가져온 이메일 그대로 사용
	 ...
	 *Math.random() 에 (90000) 곱하기를 해주면 0.0 부터 89999.999 사이의 값을 반환
	 *정수의 경우에는 맨 앞자리나 001 0이 아닌 수가 나오기 전까지 모두 0이면
	 *001 -> 1로 변하는 마법
	 *01055556666 -> 1055556666
	 *100000 ~ 189999 사이의 임의의 숫자 6자리 생성
	 *
	 *만약에 5자리
	...
	public MimeMessage createMail(String mail) {
		...
		// MimeMessage 이메일 본문 담당 첨부파일 헤더 첨부파일이나 헤더 같이 보낼 수 있음
		// 자바에서 제공하는 기능
