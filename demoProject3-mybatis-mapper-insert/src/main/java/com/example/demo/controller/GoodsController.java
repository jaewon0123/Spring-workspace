...
//class 명을 Controller 로 작성하면 기존에 Spring 에 존재하는 Controller 와 충돌이나서 Spring 안에 있는
...
public class GoodsController {
	...
	public String insertGoods(Goods goods, Model model) {
		 ...
		 * Goods.java의 변수명과 Form 에 적은 name 값이 일치할 경우
		 * 자동으로 Goods.java라는 곳에 일치하는 변수명에 form 에 작성하는 값이 바로바로
		 * 임시저장 (할당됨)
		 * 
