...
public class PigService {
	...
	public void uploadPig(String pig_name, int pig_age, MultipartFile file) {
		...
		//String uploadDir = "C:/Users/user1/servlet_jsp_workspace/demoProject3-mybatis-mapper-selet-image/src/main/resources/static/images";
		...
		if(!imgFile.exists()/*만약에 이미지 폴더가 존재하지 않을 때 true인 ! 추가 */) {
			//폴더 생성
