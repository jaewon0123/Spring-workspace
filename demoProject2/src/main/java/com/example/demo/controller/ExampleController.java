...
@Controller // 요청하거나 응답제어 역할을 명시 Bean 등록 Bean = Spring에서 어떤 기능을 하나 설정해놓은 값
...
public class ExampleController {
	 ...
	 * - @SessionAttributes 와 함께 사용할 경우 session scope 변환
	 * [기본 사용법]
	 * Model.addAttribute("key",value);
	 * Model.addAttribute("htmml에 전달가능한 이름", 전달할 값을 작성);
	 */
	...
	public String ex1(HttpServletRequest req, Model model) {
		...
		mem.setMemberNo("3456");
		mem.setMemberName("동그라미");
		mem.setMemberAge(25);
